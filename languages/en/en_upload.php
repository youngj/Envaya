...
return array(    
    'upload:image:current' => "Current image:",
    'upload:image:new' => "New image:",
    'upload:image:optional' => "Leave blank if you don't want an image.",
    'upload:image:delete' => "Remove image?",
    
    'upload:photos:title' => "Add photos",
    'upload:photos:label' => "Choose the photos you want to add:",
    'upload:photos:more' => "Add More Photos",
    'upload:photos:success' => "Photos saved successfully.",

    'upload:photo' => "Select a photo:",
    'upload:photo:caption' => "Photo description:",
