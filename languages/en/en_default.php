...
return array(
    ...
    'feed' => "Updates",
    'feed:noresults' => "No updates found.",
    'feed:title' => "Latest updates",
    'feed:registered' => "%s joined Envaya.",
    'feed:news' => "%s added a %s.",        
    'feed:news_multi' => '%s added %3$d %2$s.',
    'feed:confirm_delete' => "Are you sure you want to delete this update?",
    'feed:item_deleted' => "Update deleted successfully.",    
    'feed:new_page' => "%s created a %s page.",
    'feed:edit_page' => "%s updated its %s page.",
    'feed:new_section' => "%s created a %s section.",
    'feed:edit_section' => "%s updated its %s section.",    
    ...
    'widget:edit_title' => "Edit %s",
    'widget:edit_section_title' => "Edit %s: %s",
