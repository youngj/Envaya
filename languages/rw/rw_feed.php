...
return array(
    ...
    'feed:item_deleted' => 'Inkuru ivuyemo neza.',
    'feed:new_page' => '{name} yakoze {title} paje.',
    'feed:edit_page' => '{name} hari ibyo yahinduye kuri {title} paje.',
    'feed:new_section' => '{name} yashyizeho {title} agace.',
