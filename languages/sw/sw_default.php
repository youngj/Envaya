...
return array(
    ...
    'feed:new_page' => "%s imeumba ukurasa wa %s.",
    'feed:edit_page' => "%s imehariri ukurasa wa %s.",
    'feed:new_section' => "%s imeumba sehemu ya %s.",
    'feed:edit_section' => "%s imehariri sehemu ya %s.",    
    ...
    'widget:add_section' => "Hariri %s: Ongeza Sehemu",
    ...
    'widget:edit_title' => 'Hariri %s',
    'widget:edit_section_title' => 'Hariri %s: %s',
