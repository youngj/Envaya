...
return array(
    ...
    'message:empty' => 'Tafadhali ingiza ujumbe.',
    'message:feedback_sent' => 'Ujumbe umepelekwa. Asante kwa maoni yako!',
    'message:email_empty' => "Tafadhali ingiza anwani yako ya email ili tuweze kujibu ujumbe wako.",        
);  