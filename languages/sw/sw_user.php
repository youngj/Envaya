...
return array(
    ...
    'user:subscribe_network' => "Nitumie email ambapo shirika jingine limeniongeza kwenye ukurasa wa Mtandao",
	'user:subscribe_discussion' => "Nitumie email ambapo mtu ameongeza ujumbe kwenye ukurasa wa Majadiliano",       
);
