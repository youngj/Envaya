...
return array(
    ...
    'feed:new_section' => "{name} imeumba sehemu ya {title}.",
    'feed:edit_section' => "{name} imehariri sehemu ya {title}.",    
       
    'feed:edit_home' => '{name} imehariri ukurasa mkuu.',
    'feed:news' => '{name} imeongeza {title}.',    
    'feed:news_multi' => "{name} imeongeza {title} {count}.",
