...
add_translation("sw",array(
    ...
    'user:notification:desc' => "Taarifa ya Envaya zinakujulisha kuhusu kazi za mashirika kama lako katika Envaya. Ukurasa huu unakuruhusu kubadilisha marudio ya kukutumia email katika %s.",
