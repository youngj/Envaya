...
add_translation("sw",array(
	...
	"why:easy" => "Ni Rahisi",
	"why:easy:summary" => "Kujenga tovuti yako na Envaya, huhitaji mafunzo sana ya kompyuta au kifaa chochote. Ndani ya muda wa dakika tano, unaweza kuumba ukurasa mkuu wa msingi  mwenyewe.",
	"why:free" => "Ni Bure",
	...
	"about:tanzania_pilot" => "Machi, 2010, Envaya ilianzisha majaribio yake Tanzania, katika ubia na Journalists Environment and HIV\/AIDS Network (JEAN-media), shirika la kitanzania la jumuiya ya kiraia, ambalo lina lengo la kutumia njia za mawasilano kutangaza na kuongeza ufahamu wa umma kwa mashirika ya jumuiya ya kiraia.",
	...
	"register:title" => "Jiandikisha kwenye Envaya",
	...
	"setup:language" => "Lugha gani utatumia kuandika maandiko katika tovuti yako (kwa mfano, lengo la juu)?",
