<?php
    ...
    $swahili = array(
        ...
        'why:easy' => 'Rahisi',
        'why:easy:summary' => "Kufanya tovuti katika Envaya, huhitaji ufundishaji maalum wa kompyuta au kifaa wo wote. Muda wa dakika tano, unaweza kuumba ukurasa mkuu wa msingi wenyewe.",
        'why:free' => "Bure",
        'why:free:summary' => "Kuajiri mtu fulani kujenga na kuendesha tovuti kwa shirika lako kunaweza ghali. Envaya ni bure.",
        'why:convenient' => "Kufaa",
        'why:convenient:summary' => "Unaweza kuongeza habari na picha mpya katika tovuti yako kwa kupeleka ujumbe mfupi (SMS) toka simu yako (kuja karibu). Unaweza pia kutumia barua pepe.",
        ...
        'about:tanzania_pilot' => "Machi, 2010, Envaya alianzisha mtihani wake Tanzania, katika ubia na Journalists Environment and HIV/AIDS Network (Mtandao wa Waandishi wa Habari, Mazingira na UKIMWI) (JEAN-media), shirika kitanzania la jumuiya la kiraia, ambalo lina lengo kutumia njia za mawasilano ku tangaza na kuongezeka ufahamu wa umma kwa mashirika ya jumuiya ya kiraia.",
        'about:team' => "Tovuti ya Envaya inaendeshwa na timu mdogo ya mhandisi wa programu ya kompyuta na watu wanaojitolea na maendeleo ya kimataifa toka Amerika na Kanada. Tunatumaini kuwa watu duniani wawe na vifaa wanavyovihitaji kutimiza malengo yao wenyewe.",
        ...
        'help:settings:email' => "Kubadili anwani yako ya barua pepe",
        ...
        'widget:news:email' => "Barua pepe",
        'widget:news:email:summary' => "Peleka barua pepe kwa %s na habari yako katika mada au mwili, na picha yo yote kama kiambatisho.",
        ...
        'registration:dupeemail' => 'Anwani hii ya barua pepe imeshatumiwa.',
