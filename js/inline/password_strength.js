...
var PasswordStrength = {
    ...
    calculate: function(password, userEasyWords)
    {
        ...
        each(P.getEasyWords(), function(w) { 
            lpass = P.removeEasyWord(lpass, w); 
        });
        
        if (userEasyWords)
        {
            each(userEasyWords, function(w) { 
                lpass = P.removeEasyWord(lpass, w); 
            });
        }
