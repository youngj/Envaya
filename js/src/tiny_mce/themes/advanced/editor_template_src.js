	...
	tinymce.create('tinymce.themes.AdvancedTheme', {
        ...
        */
		...
		_createBlockFormats : function() {
			...
			c = t.editor.controlManager.createListBox('formatselect', {title : 'block', onselect : function(v) {
        ...
        */
		...
		renderUI : function(o) {
            ...
            */
			...
			n = p = DOM.create('span', {role : 'application', 
                /* 'aria-labelledby' : ed.id + '_voice', */ 
                id : ed.id + '_parent', 'class' : 'mceEditor ' + ed.settings.skin + 'Skin' + (s.skin_variant ? ' ' + ed.settings.skin + 'Skin' + t._ufirst(s.skin_variant) : '')});
...
*/
        ...
        */
		...
		_nodeChanged : function(ed, cm, n, co, ob) {
			...
			if (c = cm.get('image'))
				c.setActive(!co && !!p && !isDoc && n.className.indexOf('mceItem') == -1);
