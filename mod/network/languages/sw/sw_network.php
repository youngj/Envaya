...
return array(
    'network:title' => "Mtandao",
        
    'network:partnerships' => "Mashirika ya Ubia",

    'network:add_partnership' => "Ongeza Shirika la Ubia",
    ...
    'network:subscription' => "Taarifa ambapo {name} imeongezwa kwenye mtandao",        
);